...
parser.add_argument('--dataroot', type=str, default='/Users/mazurovev/PycharmProjects/graph-ml-for-eeg/data', help='root directory of the dataset')
...
parser.add_argument('--indim', type=int, default=300, help='feature dim')
parser.add_argument('--nroi', type=int, default=300, help='num of ROIs')
